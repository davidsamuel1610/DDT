    ...
    public class User
    {
        ...
        public string Log() 
        {
            ...
            try
            {
                ...
                {
                    //1-11
                    string page = '"'+"TeamDescription.aspx?Team="+reader[2]+'"';
                    string pageDirect = "<a href=" + page + ">" + reader[2] + "</a>";
                    string TeamRow = String.Format("<tr>\n<td>{11}</td>\n<td>{0}</td>\n<td>{1}</td>\n<td>{2}</td>\n<td>{3}</td>\n<td>{4}</td>\n<td>{5}</td>\n<td>{6}</td>\n<td>{7}</td>\n<td>{8}</td>\n<td>{9}</td>\n<td>{10}</td>\n</tr>\n", pageDirect, reader[3], reader[4], reader[5], reader[6], reader[7], reader[8], reader[9], reader[10], reader[11], reader[12], position);
                    teamId.Add(TeamRow);
                    position++;
