<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fixtures.aspx.cs" Inherits="DDT_csharp.Contactus" %>
...
<link rel="stylesheet" type="text/css" href="css/styles.css"/>
   ...
   <h2>
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="idfixture" DataSourceID="SqlDataSource1">
           <Columns>
               <asp:BoundField DataField="idfixture" HeaderText="idfixture" ReadOnly="True" SortExpression="idfixture" />
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ddt_dataConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ddt_dataConnectionString2.ProviderName %>" SelectCommand="SELECT idfixture, `Date`, `Time`, `Team A`, VS, `Team B`, referee, scoreA, scoreB, Winner FROM fixture"></asp:SqlDataSource>
       </h2>
    <p></p>
